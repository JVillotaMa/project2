...
// -------------------- Dietas --------------------
export const dietasSchema = z.object({
...
// -------------------- Neumáticos --------------------
export const neumaticosSchema = z.object({
...
export const mantenimientoSchema = z.object({
  mantenimientoAnual: z.number().min(0, "El campo Coste anual por vehículo debe estar relleno"),
});

// -------------------- Peajes --------------------
export const peajesSchema = z.object({
...
export const calculadoraMercanciasSchema = vehiculoSchema
  ...
  .merge(amortizacionSchema)
  .merge(financiacionSchema)
  .merge(personalSchema)
  .merge(impuestosSchema)
  .merge(segurosSchema)
  .merge(combustibleSchema)
  .merge(dietasSchema)
