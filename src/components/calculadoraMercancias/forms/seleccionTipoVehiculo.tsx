        ...
        <div className="flex flex-col gap-5 ">
            ...
            <SectionContainer subSectionTitle="Datos iniciales">
                <div className="flex flex-col gap-10 px-15 py-10 justify-center">
                    ...
                    <div id="showVehicleData" className="flex flex-col gap-4 max-w-md mx-auto w-full border p-4 rounded-md bg-gray-50 shadow-sm">
                        <h3 className="text-md font-semibold border-b pb-2 mb-2">
                            {indexVehiculo !== null 
                                ? <span className="text-blue-600">Datos del vehículo: {vehiculos[indexVehiculo].nombreVehiculo}</span>
                ...
                <PopoverTrigger asChild>
                    ...
                    >
                        {selectedVehicle !== null
                            ? <span className="font-medium text-blue-600">{vehiculos[selectedVehicle].nombreVehiculo}</span>
