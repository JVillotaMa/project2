        ...
        <div className="flex flex-row ">
            <div id="left-bar">
                <NavigationLeftBar>
                    ...
                    <ButtonsNavigation onClick={() => handleClick(3)} text="Personal" index={3} isSelected={viewIndex == 3} />
                    <ButtonsNavigation onClick={() => handleClick(4)} text="Impuestos" index={4} isSelected={viewIndex == 4} />
                    ...
                    <ButtonsNavigation onClick={() => handleClick(8)} text="Mantenimiento" index={8} isSelected={viewIndex == 8} />
                    <ButtonsNavigation onClick={() => handleClick(9)} text="Dietas y peajes" index={9} isSelected={viewIndex == 9} />
                    <ButtonsNavigation onClick={() => handleClick(10)} text="Costes indirectos" index={10} isSelected={viewIndex == 10} />
                    <br></br>
                    <ResultsButton disabled={(/** All the forms must been correct */ false)} onClick={() => handleClick(11)} text="Resultados" index={11} isSelected={viewIndex == 11} />
                </NavigationLeftBar>
            </div>
